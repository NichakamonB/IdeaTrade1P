...
export default function Gold() {
  ...
  const features = [
    ...
    },
    {
      ...
      desc: `Monitor market volatility in real-time. When the VIX spikes, gold often transitions into its role as a "Safe Haven," allowing you to capitalize on sudden surges in demand.`,
    },
    {
      title: "DXY Correlation",
      desc: `Stay ahead of the U.S. Dollar—the primary driver that typically moves inversely to gold. Use this to time your entries perfectly when the Dollar shows signs of weakness.`,
    },
    {
      title: "US10YY (Yield Monitor)",
      desc: `Track the U.S. 10-Year Treasury Yield to assess interest rate directions. Since yields represent the "opportunity cost" of holding gold, this feature helps you anticipate capital shifts between bonds and bullion.`,
    },
  ];
