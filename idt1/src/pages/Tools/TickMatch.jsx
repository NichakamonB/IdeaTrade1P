  ...
  const features = [
    {
      ...
      desc: `Track global gold prices with an intelligent filtering system designed to eliminate market noise and pinpoint where Smart Money is actually reversing course.`,
    },
    {
      title: "Flip Signal",
      desc: `Instantly detect the moment capital flow reverses direction. This feature alerts you when market bias shifts from bullish to bearish (or vice versa), allowing entry or exit at primary inflection points.`,
    },
    {
      title: "Granular Tick Data",
      desc: `Audit every single transaction. Our system scans for whale orders hidden within the noise, protecting you from manipulation and revealing the true intentions of large-scale traders.`,
    },
    {
      title: "Price-Based Distribution",
      desc: `Identifies price levels where the heaviest trading volume has occurred. Calculates the true average cost of the market, helping pinpoint key support and resistance zones based on real capital commitment.`,
    },
  ];
