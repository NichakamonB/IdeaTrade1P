  ...
  const features = [
    {
      ...
      desc: `Instantly connects every DR on the Thai board to its underlying international parent stock. No more confusion over tickers — access a unified global asset view in seconds.`,
    },
    {
      title: "Arbitrage Tracking",
      desc: `Compare the parent stock’s price against the Thai DR on a dual-pane screen. Instantly detect Premium or Discount spreads to execute trades at the most favorable valuation.`,
    },
    {
      title: "Real-Time Valuation",
      desc: `Monitor live P/E ratios and key fundamental metrics of the underlying global stocks. Instantly verify whether a DR is undervalued or overpriced based on true performance.`,
    },
    {
      title: "Multi-Market Correlation",
      desc: `View a comprehensive heat map of global markets within a single dashboard. Diversify intelligently and rotate capital toward regions and sectors with strong growth momentum.`,
    },
  ];
